...
public class VideoEnabledWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener
{
    ...
    private View regularSizeVideoView;
    private ViewGroup fullScreenVideoView;
     ...
     * @param regularSizeVideoView A View in the activity's layout that contains every other view that should be hidden when the video goes full-screen.
     * @param fullScreenVideoView A ViewGroup in the activity's layout that will display the video. Typically you would like this to fill the whole layout.
     */
    @SuppressWarnings("unused")
    public VideoEnabledWebChromeClient(View regularSizeVideoView, ViewGroup fullScreenVideoView)
    {
        this.regularSizeVideoView = regularSizeVideoView;
     ...
     */
    @SuppressWarnings("unused")
    public VideoEnabledWebChromeClient(View regularSizeVideoView, ViewGroup fullScreenVideoView, View loadingView)
    {
        this.regularSizeVideoView = regularSizeVideoView;
        this.fullScreenVideoView = fullScreenVideoView;
     ...
     */
    @SuppressWarnings("unused")
    public VideoEnabledWebChromeClient(View regularSizeVideoView, ViewGroup fullScreenVideoView, View loadingView, WebView webView)
    {
        this.regularSizeVideoView = regularSizeVideoView;
        this.fullScreenVideoView = fullScreenVideoView;
        this.loadingView = loadingView;
    ...
    public void onShowCustomView(View view, CustomViewCallback callback)
    {
        if (view instanceof FrameLayout)
        {
            ...
            regularSizeVideoView.setVisibility(View.INVISIBLE);
            fullScreenVideoView.addView(videoViewContainer, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
    ...
    public void onHideCustomView()
    {
        ...
        if (isVideoFullscreen)
        {
            ...
            fullScreenVideoView.removeView(videoViewContainer);
            regularSizeVideoView.setVisibility(View.VISIBLE);
